...
export class UnitConverterService {
  ...
  hasEnoughStock(
    ...
    try {
      ...
      const req = requiredAmount instanceof Decimal ? requiredAmount : new Decimal(requiredAmount);
  ...
  private convertMassToVolume(mass: Decimal, fromUnit: string, toUnit: string, ingredient?: Ingredient): Decimal {
    if (!ingredient) {
  ...
  private convertVolumeToMass(volume: Decimal, fromUnit: string, toUnit: string, ingredient?: Ingredient): Decimal {
    if (!ingredient) {
  ...
  private convertWithinCategory(quantity: Decimal, fromUnit: string, toUnit: string): Decimal {
