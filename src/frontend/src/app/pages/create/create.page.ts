      ...
      <form [formGroup]="form" (ngSubmit)="onSubmit()" class="create-form card">
          ...
          @for (group of ingredientsArray.controls; track $index; let i = $index) {
            <div class="ingredient-row" [formGroupName]="i">
              <div class="ingredient-search">
                ...
                />
                @if (
                  (perRowState()[i]?.searchResults?.length ?? 0) > 0 && perRowState()[i]?.searchOpen
                ) {
              ...
              <input
                type="text"
                class="form-input measure-input"
        ...
        <div class="form-actions">
          <app-button
            variant="outline"
            type="button"
            (action)="router.navigate(['/discover'])"
            [disabled]="submitting()"
            >Cancel</app-button
          >
          <app-button
