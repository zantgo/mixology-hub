...
const hierarchical_ingredient_service_1 = require("./hierarchical-ingredient.service");
...
exports.IngredientsModule = IngredientsModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [ingredients_service_1.IngredientsService, hierarchical_ingredient_service_1.HierarchicalIngredientService],
        exports: [typeorm_1.TypeOrmModule, ingredients_service_1.IngredientsService, hierarchical_ingredient_service_1.HierarchicalIngredientService],
    })
], IngredientsModule);
